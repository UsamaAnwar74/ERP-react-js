...
import EditExpensesForm from "./Editexpenses";
...
// .innerHTML=tableData;
  ...
  return (
    <div>
      <button className="sm-btn" onClick={toggleForm}>Add Expeness</button>
      <div className={`employeeform-container ${activeClass ? "show" : ""}`}>
        ...
        <div className={"employee-form"}>
          <ExpensesForm toggleForm={toggleForm}
           />
        </div>
      </div>
      ...
      <div className={`employeeform-container ${activeClass ? "show" : ""}`}>
        ...
        ></div>
        <div className={"employee-form"}>
          <EditExpensesForm toggleForm={toggleForm}
           />
        </div>
      </div>
